...
class Gallery < ActiveRecord::Base
  ...
  has_attached_file :avatar, styles: { medium: "300x150#", thumb: "100X100#", large: "560x290#" }, default_url: "http://i592.photobucket.com/albums/tt5/Mardini03/imagen-no-disponible.png"
